...
class HttpCache implements HttpKernelInterface, TerminableInterface
{
    ...
    {
        // FIXME: catch exceptions and implement a 500 error page here? -> in Varnish, there is a built-in error page mechanism id:220 gh:221
    ...
    protected function forward(Request $request, $catch = false, Response $entry = null)
    {
        ...
        // FIXME: we probably need to also catch exceptions if raw === true id:226 gh:227
